<template>
	<view>
		<cu-custom bgColor="bg-gradual-pink" :isBack="true">
			...
			<block slot="content">二级分销商</block>
		</cu-custom>
		<view class="cu-bar bg-white search fixed" :style="[{top:CustomBar + 'px'}]">
			...
			<view class="action">
				<button class="cu-btn bg-gradual-green shadow-blur round" @tap="searchIndex">搜索</button>
			</view>
		</view>
			...
			<block v-for="(item,index) in list" :key="index">
				<view v-if="!!item.lists.length" :class="'indexItem-' + item.name" :id="'indexes-' + item.name" :data-index="item.name">
					...
					<view class="cu-list menu-avatar no-padding">
						<view class="cu-item" v-for="(items,sub) in item.lists" :key="sub" @tap="toNavigate" :data-id="items.id" data-url="/pages/user/myPromoteThird/myPromoteThird">
