<template>
	<view class="comicStyleWrap padding-top-xl bg-white">
		...
		<view class="cu-list menu-avatar radius">
			<view class="padding solid-bottom" v-for="(item, index) in comicContent" :key="index">
				...
				<view class="content">
					...
					<!-- <view class="text-gray text-sm"> -->
						...
						<view class="text-orange" style="line-height: 2;">订单号: {{ item.orderNo || '' }}</view>
						<view class="text-red">
							<text>充值金额: {{ item.orderFee || 0 }}元</text>
							<text class="text-grey text-xs text-right" style="float: right;">{{ item.createTime }}</text>
						</view>
				...
				<!-- <view class="action padding-right-sm" style="width: 260rpx;">
					...
					<view class="cu-tag round bg-grey sm" style="float: right;">{{ item.outUserLevel }}</view>
				</view> -->
			</view>
			<!-- <view class="cu-item">
